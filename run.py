...
if args.is_training:
    ...
    print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
    setting='Wind_SHSBATransformer_48_24_SHSBATransformer_Global_Wind_ftM_sl48_ll24_pl24_node350_node[7, 50]_bs32_dm768_nh16_el2_dl1_df2048_fc1_fct1_fcs1_ebtimeF_dtTrue_Exp_0'
